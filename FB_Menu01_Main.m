%% Psychtoolbox 
%  This part of the psychtoolbox needs to be runned again to run the script
...
textpos_1x = 500;    textpos_1y = 20;   % FRONT
...
while(true_feedback);
    ...
    if (time >= sec + wait_acquisition) 
        ...
        if ( ~isempty(devents) ) 
            ...
            switch predTgt
                case 1 % Freq. of block 1 --> go to TV menu
                    FB_Menu02_TV
                case 2 % Freq. of block 2 --> go to Call menu
                    FB_Menu03_Call
                case 3 % Freq. of block 3 --> go to Move menu
                    FB_Menu04_Move  
